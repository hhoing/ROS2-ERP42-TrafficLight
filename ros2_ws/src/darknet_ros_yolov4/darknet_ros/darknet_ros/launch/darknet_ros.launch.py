...
def generate_launch_description():
  ...
  image = LaunchConfiguration('/camera1/image_raw', default = 'image_raw')
  # image = LaunchConfiguration('concated_cam', default = 'image_raw')
  ...
  ros_param_file = LaunchConfiguration('ros_param_file', default = darknet_ros_share_dir + 'config/no_touch/ros.yaml')
  network_param_file = LaunchConfiguration('network_param_file', default = darknet_ros_share_dir + 'config/no_touch/yolov4-tiny.yaml')
